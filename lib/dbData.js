...
import SiteTheme, { DEFAULT_THEME } from "../models/SiteTheme.js";
...
const initialProjects = [
  ...
  },
  {
    ...
    liveLinks: [{ label: "Live Site", url: "https://retreat-bookings.vercel.app" }],
    codeLink: "https://github.com/MuhammadWaqar7615/",
    status: "live",
    order: 2,
  },
  {
    ...
    liveLinks: [{ label: "Live Site", url: "https://irfan-alyy.github.io/Ecommerce-Store/" }],
    codeLink: "https://github.com/MuhammadWaqar7615/",
    status: "live",
    order: 3,
  },
...
export async function getSiteTheme() {
  try {
    ...
    console.error("Error fetching SiteTheme from MongoDB, using code-level defaults:", err);
    return DEFAULT_THEME;
  }
}

export const getThemeSettings = getSiteTheme;
