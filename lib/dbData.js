...
const initialExperiences = [
  {
    ...
    company: "Independent Engineering / Contract",
    duration: "2023 — Present",
    description:
      "Architected and delivered custom full-stack web applications for global clients. Specialized in Next.js App Router, Node.js REST APIs, Express, MongoDB Atlas, and Tailwind CSS with 100/100 Lighthouse performance optimization.",
    order: 1,
  },
];
...
const initialEducation = [
  {
    ...
    year: "2020 — 2024",
    description:
      "Specialized in Software Engineering, Data Structures & Algorithms, Database Management Systems, and Web Application Architecture.",
    order: 1,
  },
];
