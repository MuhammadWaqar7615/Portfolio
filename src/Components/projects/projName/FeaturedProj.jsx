  ...
  const projects = [
    {
      ...
      description: "A beautifully crafted web application showcasing artisanal gifts and delightful treats, designed with a focus on elegant UI and smooth user interactions.",
      image: "",
    ...
    },
    {
      ...
      description: "A dynamic booking platform tailored for retreat management, enabling users to explore and reserve properties with an integrated scheduling system.",
      image: "",
    ...
    {
      title: "WorkNexus",
      description: "A comprehensive Enterprise Resource Management (ERM) solution built to optimize internal business processes and facilitate seamless team coordination.",
      image: "",
    ...
    },
    {
      ...
      description: "A scalable e-commerce solution featuring a modern product catalog, secure checkout flows, and a fully responsive design for a premium shopping experience.",
      image: "",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
            {projects.map((project, idx) => (
              <motion.div
                ...
                className="group relative flex flex-col rounded-2xl bg-[#111122] p-4 border border-white/5 transition-all duration-500 hover:border-purple-500/30 overflow-hidden"
              >
                ...
                <div className="mb-4 flex flex-wrap gap-2 relative z-10">
                  {project.tech?.map((t) => (
                    <span key={t} className="text-[8px] uppercase tracking-wider text-purple-300 font-bold bg-purple-500/5 px-2.5 py-0.5 rounded-full border border-purple-500/10">
                      {t}
                    </span>
                  ))}
                </div>
