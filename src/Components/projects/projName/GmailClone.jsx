      ...
      <div className="relative rounded-2xl bg-[#111122] border border-white/10 overflow-hidden shadow-lg transition-all duration-300 hover:border-purple-500/50 hover:shadow-purple-500/20 hover:shadow-xl flex flex-col">
        ...
        <div className="p-4 flex flex-col flex-1">
          ...
          <p className="text-gray-300 text-xs mb-3 line-clamp-2">
            Designed a static Gmail homepage clone using HTML and CSS, replicating the layout and styling of Gmail's landing page.
          </p>
          ...
          <div className="flex gap-2 mt-auto">
            <a
              href="https://github.com/MuhammadWaqar7615/Gmail_Clone"
              target="_blank"
            ...
            <a
              href="https://muhammadwaqar7615.github.io/Gmail_Clone/"
              target="_blank"
              rel="noopener noreferrer"
