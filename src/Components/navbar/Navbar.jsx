    ...
    >
      <nav className="rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 shadow-lg">
        <div className="flex h-14 items-center justify-between px-4">
          ...
          <motion.button
            onClick={() => {
              console.log("Button clicked, onSidebarToggle is:", onSidebarToggle);
              if (typeof onSidebarToggle === 'function') {
                onSidebarToggle();
              } else {
                console.error("onSidebarToggle is not a function!");
              }
            }}
            className="md:hidden text-gray-200 hover:text-white focus:outline-none z-50"
            whileTap={{ scale: 0.9 }}
          >
