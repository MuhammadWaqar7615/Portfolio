  ...
  const featuredProjects = [
    {
      ...
      category: "Artisanal E-Commerce & Gift Platform",
      problem:
    ...
    },
    {
      ...
      category: "Hospitality & Scheduling Platform",
      problem:
    ...
    },
    {
      ...
      category: "Modern Cloud Retail Experience",
      problem:
      ...
      <div className="editorial-container">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 border-b border-white/[0.08] pb-6 gap-4">
          ...
          <p className="text-xs font-mono uppercase tracking-widest text-gray-400">
            [ 03 SELECTED DEPLOYMENTS // LIVE ONLY ]
          </p>
        </div>
          ...
          {featuredProjects.map((project) => (
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                {/* Main Content: Title, Problem, Solution, Outcome */}
